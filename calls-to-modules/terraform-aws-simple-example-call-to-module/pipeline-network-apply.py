...
applyCommand="terraform apply -auto-approve -var 'aws_region="+region+"' -var 'path_to_ssh_keys="+path_to_ssh_keys+"' -var 'name_of_ssh_key="+name_of_ssh_key+"' -var '_public_access_key="+os.environ['AWS_PUB']+"' -var '_secret_access_key="+os.environ['AWS_SECRET']+"'"
