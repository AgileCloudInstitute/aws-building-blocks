...
##Output variables
output "public_ip_of_ec2_instance" { value = module.snet-vm.public_ip_of_ec2_instance }
output "ami_id" { value = module.snet-vm.ami_id }
output "subnet_id" { value = module.snet-vm.subnet_id }
